...
from tkinter import Button, Label, Scrollbar, ttk
...
# BODY FRAME with database information
...
info_frame = tk.LabelFrame(root, text="Database information", bg=BACKGROUND, fg=WHITE)
...
symbols_frame = tk.LabelFrame(root, text="Symbols statistics", bg=BACKGROUND, fg=WHITE)
...
prices_frame = tk.LabelFrame(root, text="Prices statistics", bg=BACKGROUND, fg=WHITE)
...
working_frame = tk.LabelFrame(root, text="Number of prices per ticker symbol", bg=BACKGROUND, fg=WHITE)
...
tree_frame = tk.LabelFrame(root, text="Number of prices per ticker symbol", bg=BACKGROUND, fg=WHITE)
...
# Update all Database information using widget conyreol varaibles that are binded to each widget
